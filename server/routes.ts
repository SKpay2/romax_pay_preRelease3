...
import { adminLogin, getAllUsers, getAllPaymentRequests, updateUserBalance, addUserDeposit, approvePaymentRequest, cancelPaymentRequest, processPaymentRequest, getPaymentRequestForAdmin, getAllOperators, createOperator, updateOperatorStatus, updateOperatorOnlineStatus, deleteOperator, updateOperatorCredentials, getOperatorStatisticsForAdmin } from "./controllers/adminController";
import { createDeposit, createAutomatedDeposit, getUserDeposits, getPendingDeposits, getAllDeposits, confirmDeposit, manualConfirmDeposit, rejectDeposit, cancelDeposit } from "./controllers/depositController";
import { operatorLogin, getPaymentRequestsForOperator, operatorProcessPayment, operatorUpdateOnlineStatus, getPaymentRequestForOperator, getOperatorStatistics } from "./controllers/operatorController";
